...
<!--        </div>-->
        ...
        <div class="mb-20">
          <div class="text-center mb-12">
            <h3 class="text-3xl font-bold text-warm-700 dark:text-dark-700 mb-4">
              {{ t('projects.collaborativeTitle') }}
            </h3>
            <p class="text-lg text-warm-600 dark:text-dark-600">
              {{ t('projects.collaborativeSubtitle') }}
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div
                v-for="project in locale.collaborativeProjectsData"
                :key="project.name"
            ...
            >
              ...
              <div class="p-6">
                <h4 class="text-2xl font-bold text-warm-800 dark:text-dark-800 mb-3">
                  {{ project.name }}
                </h4>
            ...
            >
              ...
              <div class="p-6">
                ...
                <button
                    ...
                    class="w-full bg-gray-400 dark:bg-gray-600 text-white py-3 rounded-xl font-semibold cursor-not-allowed transition-all duration-300"
                >
                  {{ t('projects.viewOnGithub') }} (Private)
                </button>
              </div>
            </div>
          </div>
